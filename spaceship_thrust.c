...
int main () {
    printf("=========Thrust level===========\n");
    Thrust_Level thrust_level = low;

    if (thrust_level == none) {
        printf("ready to go level\n");
    } else if (thrust_level == maximum) {
        printf("take off level\n");
    } else if (thrust_level == medium) {
        printf("entry into the ionosphere\n");
    } else {
